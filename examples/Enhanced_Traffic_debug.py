...
class TomTomClient:
    ...
    def get_incidents_data(self, bbox, language="en-US"):
        ...
        try:
            ...
            # For debugging, print more details about the response
            if hasattr(e, 'response') and e.response is not None:
                print(f"Response content: {e.response.text[:200]}...")  # Print first 200 chars
            return {"incidents": []}  # Return empty incidents list instead of None
...
class TrafficVisualizer:
    ...
    def get_marker_icon(self, traffic_data):
        ...
        # Make sure color is in the allowed list
        allowed_colors = {'green', 'black', 'pink', 'beige', 'orange', 'lightgray', 
                        'darkred', 'darkblue', 'gray', 'lightblue', 'red', 
                        'darkgreen', 'purple', 'blue', 'darkpurple', 'white', 
                        'cadetblue', 'lightgreen', 'lightred'}
    
        if color not in allowed_colors:
            # Map to closest allowed color
            if color == "lightgreen":
                color = "green" 
            elif color == "darkred":
                color = "red"
...
def demo_single_intersection():
    ...
    intersection_points = {
        ...
        "South Approach": (33.950463298954155, -84.52028944936491),
...
def demo_multi_intersection():
    ...
    intersections = {
        "Roswell & Hwy 41": {  # First intersection
            ...
            "South": (33.950463298954155, -84.52028944936491),
